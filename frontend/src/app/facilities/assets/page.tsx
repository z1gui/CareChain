  ...
  return (
    <>
      <main className="max-w-7xl mx-auto px-8 py-8 pt-24">
        ...
        {/* Title & Header */}
        <div className="mb-12">
          <h1 className="text-4xl font-extrabold tracking-tight text-on-surface mb-2 font-headline">Asset Management</h1>
          <p className="text-on-surface-variant max-w-2xl">Manage your BedRight NFT equity, view real-time yields, and configure elderly care priority access.</p>
        </div>
            ...
            <div className="sm:w-2/3 p-6 flex flex-col justify-between">
              <div>
                <div className="flex justify-between items-start mb-2">
                  <div>
                    <h3 className="text-xl font-bold text-on-surface tracking-tight font-headline">FSH-A301</h3>
                  ...
                  <div className="text-right">
                    ...
                    <p className="text-lg font-extrabold text-tertiary">7.2%</p>
                  </div>
                </div>
                <div className="mt-4 inline-flex items-center px-3 py-1.5 rounded-lg bg-surface-container-high text-on-surface-variant text-sm font-medium">
                  <span className="material-symbols-outlined text-base mr-2" style={{ fontVariationSettings: '"FILL" 1' }}>payments</span>
                  Yield Mode
                </div>
              </div>
          ...
          <div className="bg-surface-container-lowest rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-all flex flex-col sm:flex-row border border-surface-container-high">
            ...
            <div className="sm:w-2/3 p-6 flex flex-col justify-between">
              <div>
                <div className="flex justify-between items-start mb-2">
                  <div>
                    <h3 className="text-xl font-bold text-on-surface tracking-tight font-headline">GZ-B102</h3>
                    <div className="flex items-center text-on-surface-variant text-sm mt-1">
                      <span className="material-symbols-outlined text-sm mr-1">location_on</span>
                      Guangzhou, China
                    </div>
                  ...
                  <div className="text-right">
                    <p className="text-xs font-medium text-on-surface-variant uppercase">Yield</p>
                    <p className="text-lg font-extrabold text-tertiary">6.8%</p>
                  </div>
                </div>
                <div className="mt-4 inline-flex items-center px-3 py-1.5 rounded-lg bg-surface-container-high text-on-surface-variant text-sm font-medium">
                  <span className="material-symbols-outlined text-base mr-2" style={{ fontVariationSettings: '"FILL" 1' }}>meeting_room</span>
                  Residence Mode
                </div>
              </div>
              <div className="mt-8 flex">
          ...
          <div className="bg-surface-container-lowest rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-all flex flex-col sm:flex-row border border-surface-container-high">
            ...
            <div className="sm:w-2/3 p-6 flex flex-col justify-between">
              <div>
                <div className="flex justify-between items-start mb-2">
                  <div>
                    <h3 className="text-xl font-bold text-on-surface tracking-tight font-headline">SZ-C505</h3>
                    <div className="flex items-center text-on-surface-variant text-sm mt-1">
                      <span className="material-symbols-outlined text-sm mr-1">location_on</span>
                      Shenzhen, China
                    </div>
                  ...
                  <div className="text-right">
                    <p className="text-xs font-medium text-on-surface-variant uppercase">Yield</p>
                    <p className="text-lg font-extrabold text-tertiary">8.1%</p>
                  </div>
                </div>
                <div className="mt-4 inline-flex items-center px-3 py-1.5 rounded-lg bg-surface-container-high text-on-surface-variant text-sm font-medium">
                  <span className="material-symbols-outlined text-base mr-2" style={{ fontVariationSettings: '"FILL" 1' }}>payments</span>
